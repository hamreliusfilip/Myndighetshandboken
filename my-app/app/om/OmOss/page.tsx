                ...
                <div className="flex justify-center mt-10">
                    <div className="p-5">
                        <div className="flex justify-center">
                            <p className="w-2/3 text-justify">Denna hemsida har utvecklats av två masterstudenter på programmet Civilingejör Medieteknik vid Linköpings universitet. Syftet med hemsidan är tekniskt och generellt samhällsintresse hos oss, bidra med en tydlig överblick över hur den svenska staten fungerar och bidra med intressant fakta och statisitik på ett och samma ställe. Den här typen av data är svår att få tag och ligger ofta djupt på statliga hemsidor det krävs ofta ett flertal källor för att få en sammanhängande bild. Denna hemsida erbjuder all denna information på ett och samma ställe, presenterat på ett intuitivt sätt. Denna hemsida är inte officiell och har ingen koppling till regeringen eller någon annan myndighet. Allt data är samlad på egen hand - liksom hemsidan och verktygen är utvecklade av oss själva.</p>
                        </div>
                        <Card className="mt-10 p-10 w-1/3 mx-auto"> 
                        <div className="flex justify-center">
                            <p>
