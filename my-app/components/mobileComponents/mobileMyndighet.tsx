...
const MobileMyndighet = ({
    ...
    handleRelationFilterChange: (filters: Record<string, boolean>) => void,
    handleRuleFilterChange: (filters: Record<string, boolean>) => void,
    handleClearFilters: () => void,
    filteredMyndigheter: any[],
    loading: boolean,
    cards: JSX.Element[],
        ...
        <div className="flex flex-col m-5 gap-0 justify-items-center">
            ...
            <div className='flex justify-between items-center mt-3'>
                ...
                <div className='w-1/2 flex justify-end'>
                    <p className="font-slate-300 font-light">Resultat: {filteredMyndigheter.length} st</p>
                </div>
            </div>
...
export default MobileMyndighet;
