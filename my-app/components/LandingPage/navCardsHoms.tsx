    ...
    return (
        <div className='mt-60'>
            <div className='flex justify-center items-center'>
                <hr className="w-24 h-1 my-4 mr-2 bg-black border-0 rounded md:my-10 dark:bg-gray-700"></hr>
                <h1 className='text-center font-bold text-2xl'>
                    <span className='text-3xl'>Utvalda höjdpunkter</span>
                </h1>
                <hr className="w-24 h-1 my-4 ml-2 bg-black border-0 rounded md:my-10 dark:bg-gray-700"></hr>
            </div>
