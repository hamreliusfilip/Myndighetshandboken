...
export default function LandingFiller4() {
    ...
    return (
        <div className='flex justify-center items-center relative mb-72'>
            <h1 className='text-left font-bold text-6xl text-black'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-4 bg-white rounded-xl p-20'>
                ...
                <Card className="w-96 h-96 bg-gradient-to-r from-cyan-500 to-blue-500">
                    <CardHeader>
